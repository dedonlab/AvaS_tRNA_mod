...
## Usage
#### 1. retrieve data from BV-BRC, including CDS sequences (ffn files), genome sequences (fna files) and protein sequences (faa files)
#### prepare genome id as a list for example gid.txt
